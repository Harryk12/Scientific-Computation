...
int main(){
  ...
  for (double vac=0.;vac<=1.;vac=vac+.1){      //iterating over vaccination rates
    for (double transmit=0.;transmit<=1.;transmit=transmit+.1){     //iterating over transmission rates
